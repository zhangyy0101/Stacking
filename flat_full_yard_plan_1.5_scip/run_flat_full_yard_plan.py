...
def run_full_yard_plan(
    ...
    return solve_full_yard_plan_df(input_adapter, config)
...
def main() -> None:
    ...
    print("\n[1/2] Solving large plan with hierarchical normalized objectives")
    ...
    summary = {
        ...
        "large_objective_mode": "hierarchical_normalized",
