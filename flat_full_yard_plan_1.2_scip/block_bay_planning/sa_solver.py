    ...
    def solve(self) -> SolveResult:
        ...
        diagnostics = {
            ...
            "big_plan_area_policy": (
                "big-plan voyage/flow/area/size quantities define the inherited area pattern; "
                "if detailed medium demand is slightly above that pattern, quotas are scaled within "
                "the same area-size combinations, and compatible non-pattern areas are allowed with "
                "a high deviation penalty when needed for feasibility"
            ),
