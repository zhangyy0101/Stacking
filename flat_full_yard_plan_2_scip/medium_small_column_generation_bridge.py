...
def build_problem_from_large_plan_json(
    ...
    data_dir = adapter_data_dir(adapter_json)
    ...
    return data_dir, problem, big_plan
...
def solve_small_plan_from_medium_json(
    ...
    big_plan = read_big_plan(big_plan_path) if big_plan_path else list(external_plan.big_plan_rows)
